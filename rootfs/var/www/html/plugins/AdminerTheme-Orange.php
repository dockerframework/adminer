...
class AdminerThemeOrange
{
	 ...
	 */
	function AdminerThemeOrange($themeName = "default-orange")
	{
	...
	public function head()
	{
		...
		<link rel="stylesheet" type="text/css" href="css/default-orange.css?">
		...
		// Warning! This will stop executing head() function in all plugins defined after AdminerThemeOrange.
		return false;
	}
}
