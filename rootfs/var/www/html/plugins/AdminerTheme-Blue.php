...
class AdminerThemeBlue
{
	 ...
	 */
	function AdminerThemeBlue($themeName = "default-blue")
	{
	...
	public function head()
	{
		...
		<link rel="stylesheet" type="text/css" href="css/default-blue.css?">
		...
		// Warning! This will stop executing head() function in all plugins defined after AdminerThemeBlue.
		return false;
	}
}
